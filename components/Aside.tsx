...
const Aside = ({ width }: any) => {
  ...
  if (loading) {
    return (
      <aside
        className={
          "flex flex-col items-center justify-center h-screen w-full max-w-[650px] "
        }
      >
    ...
    >
      <div className="w-full flex flex-col items-center justify-center h-[10%] bg-gradient-to-r from-[#11193a] to-[#36457a] font-bold text-white py-1">
        ...
        <h2 className="font-bold text-2xl">
          {stats != null ? stats.category : "Kategorie"}
        </h2>
      </div>
      <div className="w-full h-[90%] flex flex-col justify-between grow">
        {stats != null && (
          <>
